...
namespace Tema3x3.ConcreteComponents.Numbers
{
    public sealed class Five : RepresentationBase
    {
        ...
        private string _numberRepresentation_Body = Constants.PIPE + Constants.UNDERSCORE + Constants.DOT + " ";
        private string _numberRepresentation_Footer = Constants.DOT + Constants.UNDERSCORE + Constants.PIPE + " ";
